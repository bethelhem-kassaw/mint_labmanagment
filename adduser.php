    ...
    <div class="" id="home">
        ...
        <div class="row tm-content-row">
          ...
          <div class="tm-block-col tm-col-account-settings">
            ...
            <h2 class="tm-block-title"> UPDATE USER</h2>
                            ...
                            <form action="database/adduser.php" method="POST" class="tm-signup-form row" >
                                  ...
                                  <div class="form-group col-lg-6">
                                      ...
                                      <select class="custom-select" name="type" value="<?php echo $row['type']?>" required="required" >
                                    ...
                                    <button  type="submit" name="update_user"class="btn btn-primary btn-block text-uppercase"> UPDATE</button>
