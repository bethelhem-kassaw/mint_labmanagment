        ...
        <div class="row tm-content-row">
          ...
          <div class="tm-block-col tm-col-account-settings">
            ...
            <h2 class="tm-block-title"> UPDATE USER</h2>
                            ...
                            <form action="database/addroom.php" method="POST" class="tm-signup-form row" >
                                  ...
                                  <!-- <div class="form-group col-lg-6">
                                    ...
                                    <button  type="submit" name="update_room"class="btn btn-primary btn-block text-uppercase"> UPDATE</button>
