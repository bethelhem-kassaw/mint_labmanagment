...
<nav class="navbar navbar-expand-xl">
        ...
        <div class="row tm-content-row">
          ...
          <div class="tm-block-col tm-col-account-settings">
            ...
            <form action="database/borrow.php" method="POST">
            <div class="form-group mb-3">
                        <label for="i_category">Select Borrower</label>
                        <select class="custom-select tm-select-accounts"id="i_catagory" name="member_id" >
                      ...
                      <?php $rowa = mysqli_fetch_array($resulta);?>
                      <input type="hidden" name="user_id" value="<?php echo $rowa[0]; ?>">
                      
                      <div class="form-group mb-3">
                        <label for="i_category">Select items max 5</label>
                      ...
                      <div class="form-group ">
                            ...
                            <button  type="submit" name="confirm_borrow"class="btn btn-primary btn-block text-uppercase"> confirm borrow</button>
